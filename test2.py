...
def plot_colored_polygon(vertices_list, colors, region_names):
    ...
    for vertices, color, region_names in zip(vertices_list, colors, region_names):
        x, y = zip(*vertices)
        ...
        plt.text(centroid_x, centroid_y, region_names, ha='center', va='center', fontweight='regular', color='#FFFFFF')
